...
namespace BlockchainAssignment
{
    class Block
    {
        ...
        public Block(Block lastBlock, List<Transaction> transactions, String minerAddress)
        {
            ...
            Stopwatch blockTimeWatch = new Stopwatch();
            blockTimeWatch.Start();
            ...
            TimeSpan tspan = blockTimeWatch.Elapsed;


            int timeTaken = (int)tspan.TotalSeconds;
            ...
            if (tspan.Seconds < blockTime || tspan.Seconds > blockTime)
            {
                int oldDifficulty = difficulty;
                difficulty = oldDifficulty * 10 / timeTaken;
            }
        ...
        public String Mine()
        {
            ...
            List<string> enonce = new List<string>();
            ...
            stopWatch.Stop();
            // Console.WriteLine("Time taken single thread: {0}", stopWatch.Elapsed);
